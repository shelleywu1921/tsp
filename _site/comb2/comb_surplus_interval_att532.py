'''
This is dedicated to finding combs for fl1577
...
def test_repetition_ktimes(k):
        ...
        trialname='retry_test_duplication_3_'+domfilename.split('.')[0]+ '_'+str(k) + '.md'
...
def comb_surplus_interval_ktimes(k):
		...
		# PLEASE CHECK THEM!!!!!!!!!!!!!!!!!!!!!!!!!
		trialname='retry_interval_3_'+domfilename.split('.')[0]+ '_'+str(k) + '.md'
		trialfile=open(trialname,'w')
