...
if __name__=='__main__':
	...
	#for the loop
	find_stable_set_ntimes = 5000000  # number of times you want to run findhandle
	####################################################################
	...
	for i in range(find_stable_set_ntimes):
	...
	trialname='test_duplication_'+domfilename.split('.')[0]+ '_6' + '.md'
