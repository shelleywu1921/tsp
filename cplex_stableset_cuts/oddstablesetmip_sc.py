...
'''
Version 1: 
1. for the type of graph that htt deals with (the type that eligible_teeth is). Does not require networkx
'''
'''
...
def odd_weighted_stable_set_1(graph):
    # LP Model:
    ## nodes
    graph_obj=[]
    graph_ub=[]
    ...
    graph_ctype = ''
    graph_colnames = []
    for nodename, xdS in graph.nodes():
